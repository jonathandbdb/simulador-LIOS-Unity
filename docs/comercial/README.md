...
| Archivo | Qué es |
|---------|--------|
| `iol-simulator-deck.html` | **El entregable.** 7 diapositivas, un solo archivo autocontenido (~66 KB). Se abre en cualquier navegador, sin internet ni dependencias. |
...
| `build-deck.py` | Sustituye los marcadores por las imágenes redimensionadas y embebidas en base64, y escribe el entregable. Hoy solo embebe el logo. |
