...
TRANSLATIONS: dict[str, dict[Lang, str]] = {
    ...
    # Hoja imprimible "de caja" (cliente final, ver @media print en provisioning.html)
    "prov.print_button":     {"es": "Imprimir",                       "en": "Print"},
    "prov.print_title":      {"es": "Configuracion de la tablet — IOLSIMULATOR", "en": "Tablet setup — IOLSIMULATOR"},
    "prov.print_step1":      {"es": "Encender la tablet (nueva o recien restablecida) hasta la pantalla de bienvenida.",
                              "en": "Turn on the tablet (new or freshly reset) until you reach the welcome screen."},
    "prov.print_step2":      {"es": "Tocar 6 veces seguidas en un espacio vacio de esa pantalla.",
                              "en": "Tap 6 times in a row on an empty area of that screen."},
    "prov.print_step3":      {"es": "Escanear este codigo.",           "en": "Scan this code."},
    "prov.print_step4":      {"es": "Si pide WiFi, elegir la red y poner la clave. Esperar sin tocar nada: la app se instala y se abre sola.",
                              "en": "If it asks for WiFi, choose the network and enter the password. Wait without touching anything: the app installs and opens on its own."},
    "prov.print_step5":      {"es": "No agregar ninguna cuenta de Google.", "en": "Do not add any Google account."},
    "prov.print_wifi_note":  {"es": "Este codigo ya incluye la conexion a la red WiFi:",
                              "en": "This code already includes the connection to the WiFi network:"},
    # Logs
