...
TRANSLATIONS: dict[str, dict[Lang, str]] = {
    ...
    "clens.hint":            {"es": "Lentes creadas desde dispositivos (Pro: privadas; Admin: genericas). Solo lectura: la creacion/edicion se hace desde el visor/tablet.",
                              "en": "Lenses created from devices (Pro: private; Admin: generic). Read-only: creation/editing happens from the headset/tablet."},
    "clens.scope.all":       {"es": "Todas",                        "en": "All"},
    "clens.scope.generic":   {"es": "Genericas",                    "en": "Generic"},
    "clens.scope.private":   {"es": "Privadas",                     "en": "Private"},
